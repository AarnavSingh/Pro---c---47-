...
function preload(){
  ...
  powerImg=loadAnimation("Images/power1.png");
}
...
function setup() {
  ...
  var PacGroup=createGroup();
  var ghostGroup=createGroup();
...
maze.add(createSprite(254,502,8,45));
 ...
 // powerpallet.addAnimationEach(powerImg);
